"""
DSQG Attention V3 — d50 Pure Geometry (J=44)
=============================================

d50 offset set: δ ∈ [0..40, 128, 384, 1536]
  41 dense local + 3 sparse = 44 total offsets.
...
Parameter: scale_embed [44, HD]
  score[n, j, h] = Q[n,h] · K[n−δⱼ,h] / √HD      (content matching, as V2)
                 ...
                 + Q[n,h] · scale_embed[j] / √HD    (Q-dynamic matched filter)
...
Testing:
  CUDA_VISIBLE_DEVICES=0 .venv/bin/python3 kernels/dsqg_d50_pure.py
"""
...
def run_tests(device='cuda'):
    print("=" * 64)
    print("DSQG V3 d50 Pure — Correctness Tests (J=44, δ∈[0..40,128,384,1536])")
    print("=" * 64)
    cfgs = [
        (1,  8,   64, 32, "tiny"),
