...
class DSQGAttentionV13Dynamic(nn.Module):
    ...
    def __init__(
        ...
        self.register_buffer(
            ...
            persistent=False,  # reconstructed from hyperparams; not saved to checkpoint
        )
        ...
        # ema_alpha: stored as non-persistent buffer so V8 checkpoints load cleanly.
        # Initialized from ema_init; will be learned during training but not required in ckpt.
