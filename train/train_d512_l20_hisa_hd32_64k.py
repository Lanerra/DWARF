"""
DWARF D=512 Triadic J=96 + HISA DSR block, 64K tokenizer variant.

Configured architecture:
  D=512, H=16 (hd=32), NUM_LAYERS=19, FFN=1536, VOCAB=65536, tied lm_head
  Triadic partitioning: 96 offsets split into 3 pure groups of 32
  DSQG kernel: V19 (sequential Givens, grouped sparse, SE gates), R_PLANES=4
  DSR block: HierarchicalSparseAttentionV15HISA(C=32, top_k=4, HISA_m=32)
  Tokenizer: results/mixed_v6_modular_fw1000000_tokenizer_64k.json
  Encoded dataset: logs/mixed_encoded_2048_v6_modular_fw1000000_64k.pt
...
LAYER_LAYOUT:
  ...
  L12: DSRBlock            -- HierarchicalSparseAttentionV15HISA (C=32, top_k=4, HISA_m=32)
  ...
  pre-DSR: 4 triads (L0-11), post-DSR: 2 triads (L13-18).

Run:
  CUDA_VISIBLE_DEVICES=0 .venv/bin/python3 -u train/train_d512_l20_hisa_hd32_64k.py
"""
...
TOKENIZER_CANDIDATES = ['results/mixed_v6_modular_fw1000000_tokenizer_64k.json']
...
CKPT_BASE_NAME    = 'd512_l20_hisa_hd32_fw1000000_64k_noffn'

CHECKPOINT_STRATEGY = os.getenv('DWARF_CKPT', 'all').lower()

# =============================================================================
# LAYER LAYOUT: 19 total blocks with DSR inserted at L12 in the static layout
# Pre-DSR: 4 triads (L00-L11), Post-DSR: 2 triads (L13-L18)
# =============================================================================
...
def train():
    ...
    print('=' * 70)
    print('  DWARF D512-L19 Triadic J=96 — HISA DSR, tied lm_head, 64K tokenizer')
    print(f'  LAYER_LAYOUT DSR block @ L{DSR_LAYOUT_INDEX}: HierarchicalSparseAttentionV15HISA(C={NUM_CHUNKS}, top_k={TOP_K_CHUNKS}, HISA_m={HISA_TOP_M_TOKENS})')
    ...
    encoded_path = 'logs/mixed_encoded_2048_v6_modular_fw1000000_64k.pt'
