...
def save_full_attn_checkpoint(model, epoch, git_hash, checkpoint_dir):
    ...
    out_path = os.path.join(checkpoint_dir, f"borg_gen3_L8_ep{epoch}_full_attn.pt")
...
def train(no_warmstart: bool = False):
    ...
    print('  FullAttn at L2 of L=8, warm-started from Gen2 full checkpoint, FA UNFROZEN for refinement')
    print('=' * 70)
    ...
    best_ckpt_name = f'borg_gen3_L8_best.pt'
    if no_warmstart:
    ...
    print(f'description:    Borg Gen3 L=8 — {n_params/1e6:.1f}M, Gen2 full warm-start, FA@L2 unfrozen, '
          f'D={EMBEDDING_DIM}, L={NUM_LAYERS}, FA@L2 unfrozen, scaling test')
...
if __name__ == '__main__':
    ...
    if args.no_warmstart:
        ...
        print("  Checkpoint: borg_gen3_L8_best.pt\n")
