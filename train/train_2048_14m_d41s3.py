...
Run:
  CUDA_VISIBLE_DEVICES=0 .venv/bin/python3 -u benchmarks/train_2048_condV.py \
    2>&1 | tee benchmarks/logs/d41s3_run.log
"""
...
SAVE_DIR    = 'checkpoints/d41s3'
RESULT_FILE = 'benchmarks/logs/d41s3_results.json'
...
from dsqg_attention_d41s3 import dsqg_attention_v3
