...
EXTRACTED_CKPT = "autoresearch/checkpoints/borg_gen5_L8_preIF_best.pt"
...
def save_full_attn_checkpoint(model, epoch, git_hash, checkpoint_dir):
    ...
    out_path = os.path.join(checkpoint_dir, f"borg_gen5_L11_preIF_ep{epoch}_full_attn.pt")
...
def train(no_warmstart: bool = False):
    ...
    best_ckpt_name = f'borg_gen5_L11_preIF_best.pt'
    if no_warmstart:
    ...
    print(f'description:    Borg Gen5 L=11 preIF — {n_params/1e6:.1f}M, Gen2 full warm-start, FA@L2 unfrozen, '
          f'D={EMBEDDING_DIM}, L={NUM_LAYERS}, pre-FA IF only, Gen5-L8 warm-start')
...
if __name__ == '__main__':
    ...
    if args.no_warmstart:
        ...
        print("  Checkpoint: borg_gen5_L11_preIF_best.pt\n")
