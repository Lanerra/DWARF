"""
DWARF D=512 L=10 Triadic J=96 — HISA/DSQG hybrid v2 L3, Bible-audited variant.
...
SCALE_EMBED_LR_MULT  = float(os.environ.get('DWARF_SCALE_EMBED_LR_MULT', '18.0'))
EMA_INIT  = 0.020833
EMA_FLOOR = 0.00001
...
CKPT_BASE_NAME    = 'd512_l10_hisa_h16_v2_l3_bible'

CHECKPOINT_STRATEGY = os.getenv('DWARF_CKPT', 'full_attn').lower()
