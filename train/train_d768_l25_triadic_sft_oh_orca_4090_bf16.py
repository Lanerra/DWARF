...
SFT notes:
  - Resumes from d768_l25_triadic_mixed_scratch_best.pt (ep3, PPL=22.88, passkey=100%)
...
def train():
    ...
    resume_path = os.getenv('DWARF_RESUME', 'autoresearch/checkpoints/d768_l25_triadic_mixed_scratch_best.pt')
