"""
DWARF D=768 L=30 Triadic J=96 — DSR/HISA@L20 + R_PLANES=4, TIED LM_HEAD

Architecture: D=768, H=24 (hd=32), L=30, FFN=1536, TIED lm_head
  Triadic partitioning: 96 offsets split into 3 pure groups of 32 (no tail)
  DSR at L20 (replacing the C-slot in triad 7):
...
All DSQG blocks use V19 R_PLANES=4 Triton kernel (sequential Givens, grouped sparse, SE gates).
  ...
  L06: DSQGBlock(GROUP_A)  -- triad 3
  L07: DSQGBlock(GROUP_B)
  L08: DSQGBlock(GROUP_C)
  L09: DSQGBlock(GROUP_A)  -- triad 4
  L10: DSQGBlock(GROUP_B)
  L11: DSQGBlock(GROUP_C)  + preIF
  L12: DSQGBlock(GROUP_A)  -- triad 5
  L13: DSQGBlock(GROUP_B)
  L14: DSQGBlock(GROUP_C)
  L15: DSQGBlock(GROUP_A)  -- triad 6
  L16: DSQGBlock(GROUP_B)
  L17: DSQGBlock(GROUP_C)  + preIF
  L18: DSQGBlock(GROUP_A)  -- triad 7
  L19: DSQGBlock(GROUP_B)
  L20: DSRBlock            -- HierarchicalSparseAttentionV15HISA (C=32, top_k=4, HISA_m=32)
  L21: DSQGBlock(GROUP_A)  -- triad 8
  L22: DSQGBlock(GROUP_B)
  L23: DSQGBlock(GROUP_C)
  L24: DSQGBlock(GROUP_A)  -- triad 9
  L25: DSQGBlock(GROUP_B)
  L26: DSQGBlock(GROUP_C)  + preIF
  L27: DSQGBlock(GROUP_A)  -- triad 10
  L28: DSQGBlock(GROUP_B)
  L29: DSQGBlock(GROUP_C)

  10 triadic slots total; DSR replaces the C-slot at L20.
  Full J=96 topological coverage within each 3-layer triad.

Run:
  CUDA_VISIBLE_DEVICES=0 .venv/bin/python3 -u train/train_d768_l30_hisa_hd32_tied.py
"""
...
MAX_TRAIN_SEQS = int(os.environ.get('DWARF_MAX_TRAIN_SEQS', '350000'))
MAX_SEQ_LEN    = 2048
MAX_VAL_SEQS   = 5_582
CE_CHUNK       = 1024
SCREEN_EPOCHS  = 3
...
CKPT_BASE_NAME    = 'd768_l30_hisa_hd32_tied'

CHECKPOINT_STRATEGY = os.getenv('DWARF_CKPT', 'all').lower()

# =============================================================================
# LAYER LAYOUT: L=30, DSR@L24 (replacing the C-slot in triad 7)
# preIF on C-slots at L05, L11, L17, and L26
# =============================================================================
...
LAYER_LAYOUT = [
    ...
    ('A', GROUP_A, J_SMALL_A, J_LARGE_A, False),   # L03
    ('B', GROUP_B, J_SMALL_B, J_LARGE_B, False),   # L04
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, True),    # L05
    ('A', GROUP_A, J_SMALL_A, J_LARGE_A, False),   # L06
    ('B', GROUP_B, J_SMALL_B, J_LARGE_B, False),   # L07
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, False),   # L08
    ('A', GROUP_A, J_SMALL_A, J_LARGE_A, False),   # L09
    ('B', GROUP_B, J_SMALL_B, J_LARGE_B, False),   # L10
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, True),    # L11
    ('A', GROUP_A, J_SMALL_A, J_LARGE_A, False),   # L12
    ('B', GROUP_B, J_SMALL_B, J_LARGE_B, False),   # L13
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, False),   # L14
    ('A', GROUP_A, J_SMALL_A, J_LARGE_A, False),   # L15
    ('B', GROUP_B, J_SMALL_B, J_LARGE_B, False),   # L16
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, True),    # L17
    ('A', GROUP_A, J_SMALL_A, J_LARGE_A, False),   # L18
    ('B', GROUP_B, J_SMALL_B, J_LARGE_B, False),   # L19
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, False),   # L20
    ('A', GROUP_A, J_SMALL_A, J_LARGE_A, False),   # L21
    ('B', GROUP_B, J_SMALL_B, J_LARGE_B, False),   # L22
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, True),    # L23
    ('DSR', None, 0, 0, False),                    # L24: HierarchicalSparseAttentionV15HISA
    ('A', GROUP_A, J_SMALL_A, J_LARGE_A, False),   # L25
    ('B', GROUP_B, J_SMALL_B, J_LARGE_B, False),   # L26
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, False),    # L27
    ('A', GROUP_A, J_SMALL_A, J_LARGE_A, False),   # L28
    ('B', GROUP_B, J_SMALL_B, J_LARGE_B, False),   # L29
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, False),   # L30
]
...
def train():
    ...
    print('=' * 70)
    print('  DWARF D768-L30 Triadic J=96 — DSR/HISA@L20 + R_PLANES=4, TIED LM_HEAD')
