#!/usr/bin/env python3
"""
🔬 DWARF D=512 L=13 TopK Sparse Attention — distillation from cached FA teacher
...
Run:
  CUDA_VISIBLE_DEVICES=0 .venv/bin/python3 -u train/train_d512_l13_topk_distill.py
"""
...
CKPT_NAME       = 'd512_l13_topk_distill'
...
def train():
    ...
    print('=' * 70)
    print('  🔬 DWARF D512-L13 TopK Distillation (cached FA teacher)')
    ...
    print(f'\n{"=" * 70}')
    print('  🔬 TopK Distillation Summary')
    print(f'{"=" * 70}')
