"""
🚀 V15 BENCHMARK — D=768 L=25 Triadic J=96 — 1-epoch tok/s comparison vs V8 baseline (~38.4K tok/s)
...
import triton
from dsqg_attention_v15 import (
    ALL_OFFSETS as _ALL_96,
    _fwd_v15 as _fwd_v8, _compute_D_v15 as _compute_D_v8, _bwd_dq_v15 as _bwd_dq_v8, _bwd_dkdv_v15 as _bwd_dkdv_v8,
...
MAX_TRAIN_SEQS = int(os.environ.get('DWARF_MAX_TRAIN_SEQS', '338000'))  # 338K seqs = 22% Chinchilla for 157M params at N=2048
MAX_SEQ_LEN    = 2048
MAX_VAL_SEQS   = 5_582
CE_CHUNK       = 512
SCREEN_EPOCHS  = 1  # V15 benchmark: 1 epoch only
...
CKPT_BASE_NAME    = 'd768_l25_triadic_j96'
