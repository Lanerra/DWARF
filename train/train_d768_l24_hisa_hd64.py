...
MAX_TRAIN_SEQS = int(os.environ.get('DWARF_MAX_TRAIN_SEQS', '460000'))
MAX_SEQ_LEN    = 2048
MAX_VAL_SEQS   = 5_582
CE_CHUNK       = 1024
SCREEN_EPOCHS  = 3
...
CKPT_BASE_NAME    = 'd512_l10_hisa_h16_v2'

CHECKPOINT_STRATEGY = os.getenv('DWARF_CKPT', 'none').lower()

# =============================================================================
# LAYER LAYOUT: L=24, DSR@L6
# Pre-DSR: 2 triads (L0-5), Post-DSR: 6 triads (L7-23)
# =============================================================================
...
LAYER_LAYOUT = [
    ...
    ('DSR', None, 0, 0, False),                    # L06: HierarchicalSparseAttentionV15HISA
    ...
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, True),    # L12
