...
SAVE_DIR    = 'checkpoints/d41_35m'
RESULT_FILE = 'benchmarks/logs/d41_35m_results.json'
...
def train(model, train_data, val_data, test_data, tokenizer, device='cuda'):
    ...
    results = {
        ...
        'changes':                 ['dense_w48_sparse96_128_384_J52', 'scale_embed_init_zero', 'ema_clamp_floor_0.001'],
...
def main():
    ...
    print('=' * 70)
    print('  d41_35m -- d41 architecture scaled to 35M (D=512, dense=48, sparse=[96,128,384])')
    print('=' * 70)
    ...
    print(f'  References: d41s3=52.457/80.0% | condU_35M=38.293/90.0% | condM_85M=36.042/--')
