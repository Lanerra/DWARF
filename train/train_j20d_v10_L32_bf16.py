"""
🔬 DWARF Autoresearch — J20D V10 L32 Depth Experiment
...
def train():
    ...
    print('=' * 70)
    print('  🔬 DWARF Autoresearch — J20D V10 L32 Depth Experiment')
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(),
                       os.path.join(CHECKPOINT_DIR,
                                    f'{git_hash}_j20d_v10_L32_best.pt'))
            marker = ' *'
    ...
    print(f'description:    J20D V10 L32 depth — {n_params/1e6:.1f}M, V8+condV, '
