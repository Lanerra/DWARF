"""
DWARF D=512 L=10 Triadic J=96 — HISA/DSQG hybrid v2 L3, Bible-Muon scratch 70/20FW/10 variant.

Scratch target: train the Bible-Muon D512 architecture from random init on the
mixed-tokenizer 70% Dolmino / 20% FineWeb-Edu / 10% Longmino cache. This is the
clean FW-Edu replacement ablation for the 70/20/10 cold-start control.
...
BATCH_SIZE     = int(os.environ.get('DWARF_BS', '28'))
...
_CKPT_BASE_DEFAULT = 'd512_l10_muon_40_30_20_10_staggered_movt' if os.getenv('DWARF_STAGGER_MOVT_PLANES', '1') == '1' else 'd512_l10_muon_70_20_10'
...
def train():
    ...
    print('  SCRATCH PRETRAINING: 70% Dolmino / 20% FineWeb-Edu / 10% Longmino. Bible-Muon defaults.')
    print('=' * 70)
