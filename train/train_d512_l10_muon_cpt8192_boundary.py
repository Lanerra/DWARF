"""
DWARF D=512 L=10 Triadic J=96 — HISA/DSQG hybrid v2 L3, Bible-Muon 8192 boundary-packed CPT variant.

CPT target: resume the D512 Muon staggered-MOVT checkpoint and adapt it to
...
Architecture: D=512, H=8 (hd=64), L=10, FFN=1536, tied lm_head
  ...
  HISA block: HierarchicalSparseAttentionV15HISA(C=128 default, top_k=4, HISA_m=32 default)
...
BATCH_SIZE     = int(os.environ.get('DWARF_BS', '12'))
GRAD_ACCUM     = int(os.environ.get('DWARF_GA', '10'))
MAX_TRAIN_SEQS = int(os.environ.get('DWARF_MAX_TRAIN_SEQS', '250000'))
...
_CKPT_BASE_DEFAULT = 'd512_l10_muon_cpt8192_boundary_500k'
...
DATASET_PATH = os.environ.get('DWARF_DATASET', 'datasets/cpt_8192_starcoder35_arxiv35_orig20_longabc10_boundary_500k.ptrom')
DEFAULT_RESUME_PATH = os.environ.get('DWARF_DEFAULT_RESUME', 'autoresearch/checkpoints/d512_l10_muon_70_20_10_staggered_movt_ep1.pt')
...
def train():
    ...
    print('=' * 70)
    print(f'  DWARF D512-L10 Triadic J=96 — V15 HISA@L{DSR_LAYER} + R_PLANES=4, TIED LM_HEAD')
    print(f'  DSR@L{DSR_LAYER}: HierarchicalSparseAttentionV15HISA(C={NUM_CHUNKS}, top_k={TOP_K_CHUNKS}, HISA_m={HISA_TOP_M_TOKENS})')
    print('  CPT: boundary-packed 8192 StarCoderData / ArXiv / original replay / LongPack mix.')
    print('=' * 70)
    ...
    print('\n' + '=' * 70)
    print(f'  DSR + R_PLANES={R_PLANES} Bible-Muon Scratch 70/20FW/10 Summary (D{EMBEDDING_DIM}-L{NUM_LAYERS}, tied lm_head)')
    print('=' * 70)
