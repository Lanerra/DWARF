...
Purpose: Test whether relay mechanism survives SFT.
  ...
  - Dataset: sft_retrieval_dataset.pt (134K examples: 80K SQuAD + 40K TriviaQA + 15K Dolly)
...
Run (from repo root):
  CUDA_VISIBLE_DEVICES=0 .venv/bin/python3 -u train/train_d768_l32_sft_4090_bf16.py \\
    2>&1 | tee logs/run_d768_l32_sft.log
"""
...
SFT_DATASET_PATH  = 'logs/sft_retrieval_dataset.pt'
