...
EXTRACTED_CKPT = "autoresearch/checkpoints/borg_midattn_best.pt"
...
def save_full_attn_checkpoint(model, epoch, git_hash, checkpoint_dir):
    ...
    out_path = os.path.join(checkpoint_dir, f"borg_midattn_gen2_ep{epoch}_full_attn.pt")
...
def train(no_warmstart: bool = False):
    ...
    print('  FullAttn at L2 (middle), warm-started from borg_midattn ep2 checkpoint, FA UNFROZEN for refinement')
    print('=' * 70)
    ...
    best_ckpt_name = f'borg_midattn_gen2_best.pt'
    if no_warmstart:
...
if __name__ == '__main__':
    ...
    if args.no_warmstart:
        ...
        print("  Checkpoint: borg_midattn_gen2_best.pt\n")
