...
START_EPOCH = 1      # set to 2 to train ep2+ep3 from ep1 checkpoint
...
def train():
    ...
    for epoch in range(START_EPOCH, SCREEN_EPOCHS + 1):
        ...
        # Save resume checkpoint for this epoch
        resume_name = f'ffn_ablation_ep{epoch}_resume.pt'
        torch.save(model.state_dict(), os.path.join(CHECKPOINT_DIR, resume_name))
