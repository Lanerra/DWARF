...
MAX_TRAIN_SEQS = int(os.environ.get('DWARF_MAX_TRAIN_SEQS', '110000'))
MAX_SEQ_LEN    = 2048
MAX_VAL_SEQS   = int(os.environ.get('DWARF_MAX_VAL_SEQS', '5582'))
CE_CHUNK       = 1024
SCREEN_EPOCHS  = int(os.environ.get('DWARF_SCREEN_EPOCHS', '3'))
...
CKPT_BASE_NAME    = 'd512_l10_hisa_h16_doubleup_fw1000000_64k'
