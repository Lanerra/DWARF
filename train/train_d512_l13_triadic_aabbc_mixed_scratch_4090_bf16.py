...
CKPT_BASE_NAME    = 'd512_l13_triadic_aabbc_mixed_scratch'
...
LAYER_LAYOUT = [
    ...
    ('C', GROUP_C, J_SMALL_C, J_LARGE_C, True),    # L2 + preIF (GROUP_C needs pre-FA priming for d=512+ relay)
...
if __name__ == '__main__' and False:
    def _test_kernel_fusion():
        ...
        mini_model = TriadicJ96(
            ...
            ffn_dim=128, seq_len=N, full_attn_layer=FULL_ATTN_LAYER,
