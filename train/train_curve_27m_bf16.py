"""
🔬 DWARF Clean Curve — 27M BF16 (4090)

Clean curve 27M — D=512, L=6, FFN=768, V=32K, J24D-int2 physics
...
Run (from /home/dlewis3/Desktop/AI/DWARF):
  CUDA_VISIBLE_DEVICES=0 .venv/bin/python3 -u train/train_curve_27m_bf16.py \
    > logs/run_curve_27m.log 2>&1 &
"""
...
CHECKPOINT_NAME = 'curve_27m_best.pt'
...
def train():
    ...
    print('=' * 70)
    print('  🔬 Clean curve 27M — D=512, L=6, FFN=768, V=32K, J24D-int2 physics')
    print('=' * 70)
    ...
    print(f'description:    Clean curve 27M — D=512, L=6, FFN=768, V=32K, J24D-int2 physics')
