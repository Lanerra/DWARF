"""
🔬 DWARF Autoresearch — J20D V10 Full-Dataset + Physics
...
def train():
    ...
    print('=' * 70)
    print('  🔬 DWARF Autoresearch — J20D V10 Full-Dataset + Physics')
    ...
    print(f'description:    J20D V10 physics — {n_params/1e6:.1f}M, V8+condV, '
