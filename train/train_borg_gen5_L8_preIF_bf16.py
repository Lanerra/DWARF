...
def save_full_attn_checkpoint(model, epoch, git_hash, checkpoint_dir):
    ...
    out_path = os.path.join(checkpoint_dir, f"borg_gen5_L8_preIF_ep{epoch}_full_attn.pt")
...
def train(no_warmstart: bool = False):
    ...
    best_ckpt_name = f'borg_gen5_L8_preIF_best.pt'
    if no_warmstart:
...
if __name__ == '__main__':
    ...
    if args.no_warmstart:
        ...
        print("  Checkpoint: borg_gen5_L8_preIF_best.pt\n")
