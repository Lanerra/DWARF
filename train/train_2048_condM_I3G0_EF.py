...
Architecture: identical to condM reference (verified)
  ...
  - INTERFERENCE = 3 (same as reference)
...
SAVE_DIR    = 'checkpoints/condM_I3G0_EF'
RESULT_FILE = 'benchmarks/logs/condM_I3G0_EF_results.json'
...
class FullAttentionBlock(nn.Module):
    ...
    def forward(self, x):
        # Change F: gradient checkpointing on O(N²) full attention block
...
def main():
    ...
    print(f'  Architecture: condM_I3G0_EF — INTERFERENCE=3, gate bias=0.0, LR warmup 200 steps, FullAttn grad checkpoint,')
