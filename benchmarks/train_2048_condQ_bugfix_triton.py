...
SAVE_DIR    = 'checkpoints/condq_bugfix'
RESULT_FILE = 'benchmarks/logs/condq_bugfix_results.json'
...
def main():
    ...
    print(f'  Architecture: identical to condM (INTERFERENCE=3, gate bias=2.0,')
