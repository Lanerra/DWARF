...
CHECKPOINT   = 'checkpoints/condX/best.pt'
RESULT_FILE  = 'benchmarks/logs/probe_bypass_gate_results.json'
...
_spec = _ilu.spec_from_file_location(
    'condX_train', os.path.join(_repo, 'train', 'train_2048_condX.py'))
...
def main():
    ...
    print('=' * 70)
    print('  probe_bypass_gate.py — condX checkpoint gate sweep')
    print('=' * 70)
    ...
    from train_2048_condX import BPETokenizerWrapper
    ...
    # ── Save ──────────────────────────────────────────────────────────────────
    out = {
        'experiment':   'probe_bypass_gate_condX',
        ...
        'sweep':        sweep_results,
        'notes': {
            'gate_1.00': 'condX hard bypass (training value)',
            'gate_0.10': 'condX-v2 converged equilibrium',
